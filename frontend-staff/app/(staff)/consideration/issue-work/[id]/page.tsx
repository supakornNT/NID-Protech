      ...
      <div className="flex flex-1 flex-col gap-5 bg-[#F0F4FA] p-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-[22px] font-bold text-gray-900">การจัดการงาน</h1>
              <p className="text-[13px] text-gray-400">มอบหมายและติดตามงานย่อย</p>
            </div>
          </div>
          <button
            type="button"
            onClick={handleSave}
            disabled={!canSubmit}
            className="rounded-xl bg-[#366DBD] px-6 py-2 text-[14px] font-semibold text-white shadow-sm hover:bg-[#2d5da3] disabled:cursor-not-allowed disabled:opacity-50"
          >
            ส่งต่อ
          </button>
        </div>
            ...
            <div className="flex flex-1 flex-col gap-4 rounded-2xl border border-gray-300 bg-white p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5">
                ...
                <input
                  ...
                  min={new Date().toISOString().split("T")[0]}
                  className="ml-auto rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-[13px] outline-none focus:border-[#366DBD]"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                {pagedSub.length === 0 ? (
                  <div className="flex flex-col items-center gap-2 py-10 text-gray-400">
                    ...
                    <span className="text-[13px]">ยังไม่มีงานย่อย</span>
                  </div>
                ) : (
                  pagedSub.map((task) => (
                    <div
                    ...
                    >
                      {/* Left accent bar */}
                      <div className="w-1 shrink-0 bg-[#366DBD]" />
                      <div className="flex flex-1 items-start justify-between gap-3 px-4 py-3">
                        <div className="flex flex-col gap-1.5 min-w-0">
                          <span className="w-fit rounded-md border border-gray-200 bg-white px-2.5 py-0.5 text-[12px] font-medium text-gray-700">
                        ...
                        <div className="flex shrink-0 gap-1.5">
                          <button
                            ...
                            className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 hover:border-[#366DBD] hover:text-[#366DBD]"
                          >
                            <Pencil size={13} />
                          </button>
                          <button
              ...
              {editedDueDate && (
                <div className="mt-auto flex justify-end">
                  <button
                    ...
                    onClick={() => updateDueDate(effectiveRequestId, editedDueDate!)}
                    className="rounded-xl bg-[#366DBD] px-6 py-2 text-[13px] font-semibold text-white hover:bg-[#2d5da3] disabled:opacity-50"
                  >
                    {dueDateLoading ? "กำลังบันทึก..." : "บันทึกวันส่ง"}
                  </button>
                </div>
              )}
            </div>
      ...
      >
        <DialogContent>
          ...
          <p className="text-[14px] text-gray-600">
            คุณต้องการลบงานย่อยนี้ใช่หรือไม่? การดำเนินการนี้ไม่สามารถย้อนกลับได้
          </p>
